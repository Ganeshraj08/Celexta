    ...
    <section className="w-full bg-background">
      ...
      <div className="mx-10 ">
        {coursesList.map((list, index) => {
          ...
          return (
            <div key={list.title}>
              <h1 className="filter-shadow ml-5 text-white font-poppins font-[500] text-xl my-3 tracking-wide">
                {list.title}
              </h1>
              <div className="relative w-[95%] m-auto max-sm:w-[100%]">
                ...
                <div
                  ref={prevRef}
                  className="swiper-button-prev p-8 absolute top-1/2 transform -translate-y-1/2 left-1 w-7 h-7 bg-black bg-opacity-50 text-purple flex items-center justify-center rounded-full cursor-pointer z-10"
                >
                  <svg
                    className="w-3 h-3"
                    fill="none"
                ...
                <div
                  ref={nextRef}
                  className="swiper-button-next p-8 absolute top-1/2 transform -translate-y-1/2 right-1 w-7 h-7 bg-black bg-opacity-50 text-purple flex items-center justify-center rounded-full cursor-pointer z-10"
                >
                  <svg
                    className="w-3 h-3"
                    fill="none"
