...
const AboutUs = () => {
  ...
  const items = [
    { content: 'Welcome to [Your Company Name], where creativity, innovation, and excellence converge. Established with a passion for [describe your company’s mission or purpose], we [briefly describe your company’s core services or products]. Our dedication to [core value or unique selling proposition] sets us apart in [your industry or market].'},
    { content: 'Meet the driving force behind [Your Company Name]. Our diverse team of professionals is dedicated to [mention key team values or goals]. Together, we strive to [describe the impact your team aims to make in your industry or community].'},
    { content: 'Welcome to [Your Company Name], where creativity, innovation, and excellence converge. Established with a passion for [describe your company’s mission or purpose], we [briefly describe your company’s core services or products]. Our dedication to [core value or unique selling proposition] sets us apart in [your industry or market].' },
    { content: 'Welcome to [Your Company Name], where creativity, innovation, and excellence converge. Established with a passion for [describe your company’s mission or purpose], we [briefly describe your company’s core services or products]. Our dedication to [core value or unique selling proposition] sets us apart in [your industry or market].' },
    { content: 'Welcome to [Your Company Name], where creativity, innovation, and excellence converge. Established with a passion for [describe your company’s mission or purpose], we [briefly describe your company’s core services or products]. Our dedication to [core value or unique selling proposition] sets us apart in [your industry or market].'}
  ];
  ...
  return (
    <div className="bg-background text-white min-h-screen flex flex-col items-center justify-center p-6">
      ...
      <div className="container mx-auto flex items-center justify-center">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 p-4">
          {cards.map((card, index) => (
            <div key={index} className="bg-purple-900 text-center p-4 rounded-lg">
              <div className="bg-gray-300 w-20 h-20 md:w-24 md:h-24 mx-auto rounded-full mb-4"></div>
              <h3 className="text-purple-400 text-lg font-semibold">{card.name}</h3>
