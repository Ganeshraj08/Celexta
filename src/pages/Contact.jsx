...
const Contact = () => {
  return (
    <div className='h-auto bg-background w-full'>
       <div className="flex items-center gap-0 justify-center mb-10">
        ...
        <h1 className="my-7 text-[#8b38cd] font-bold text-[60px] font-roboto text-shadow-[0_0_1px_#ffffff]">
          Contact Us
        </h1>
      </div>
      <div className='flex gap-7 mx-4 pb-4 px-4 '>
        <div className=' w-1/2 mx-auto'>
              ...
              <div className='bg-darkgradient overflow-hidden mx-auto shadow-custom-white rounded-xl '>
                    ...
                    <div className='bg-primary mx-3 rounded-sm mb-5 w-11/12  flex flex-col items-center md:flex-row items-center '>
  <div className='flex flex-col flex-1 p-2 '>
    <div className='flex gap-2 items-center'>
      <img src={PlaceMarker} alt="Place Marker" height={30} width={30} />
      <div>
      <h6 className='text-white text-sm'>24, main road north street</h6>
  ...
  <div className='flex flex-1 flex-col items-center justify-center p-4'>
    <div className='flex gap-2 items-center'>
      ...
      <h6 className='text-white text-sm font-weight-300'>998877665544</h6>
    </div>
    <div className='flex gap-2 items-center'>
      <img src={Envelope} alt="Envelope Icon" height={30} width={30} />
      <h6 className='text-white text-sm font-weight-300'>clexta@gmail.com</h6>
    </div>
  </div>
</div>
