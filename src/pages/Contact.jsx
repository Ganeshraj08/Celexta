  ...
  return (
    <div className="h-auto bg-background w-full  overflow-hidden">
      ...
      <div className="flex flex-col gap-0 mx-0 pb-4 px-3 items-center justify-center w-full sm:flex-row sm:mx-20 md:px-20">
        <div className=" mx-auto  mb-4 sm:w-[35%] sm:h-[430px] ">
        ...
        <div className="flex-1 ">
          ...
          <div className="w-full mx-auto rounded-xl bg-customgradient sm:w-[50%]  h-[390px]">
            <form className="flex flex-col">
              <div className=" my-3 ml-8  w-3/4">
                ...
                <textarea
                  type="text"
                  className="block w-full p-4 text-white border border-transparent rounded-sm bg-whitebg text-sm focus:ring-blue-500 focus:border-none outline-none  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                />
              </div>
